                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"> {{trans('admin.donations')}}
                            </li>
                        </ol>
                    </div>
                </div>
                                  ...
                                  <table class="table display nowrap table-striped table-bordered w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $value->name }}</td>
                                                <td>
                                                    @include('dashboard.components.table-control', ['permission' => 'donations',
                                                    'name'=>'donations', 'value'=>$value])
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    ...
                                    <div class="justify-content-center d-flex">
                                        {{ $donations->links('vendor.pagination.custom') }}
                                    </div>
                                </div>
                            </div>
                        </div>
