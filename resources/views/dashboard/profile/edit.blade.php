                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{trans('admin.edit_profile')}} 
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{trans('admin.edit_profile')}} </h4>
                                        ...
                                        <form class="form" action="{{route('update.profile')}}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">   {{trans('admin.new_password')}}</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{trans('admin.confirm_password')}}  </label>
                                                            <input type="password" value="" id=""
                                                                   class="form-control"
                                                                   placeholder=" "
