                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{trans('admin.create_role')}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> {{trans('admin.create_role')}} </h4>
                                        ...
                                        <form method="POST" action="{{ route('roles.store') }}">
                                            ...
                                            <table class="table table-striped">
                                                <thead>
                                                    ...
                                                    <th scope="col" width="20%">{{trans('admin.name')}}</th>
